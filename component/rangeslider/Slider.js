...
(function()
{
	...
	_.rightMouseMove=function(event)
	{
		...
		if(this.x+(this.buttonWidth*2)+w>this.element.parentNode.clientWidth)w=this.element.parentNode.clientWidth-(this.x+(this.buttonWidth*2)+w);
	...
	_.setX=function()
	{
		...
		if(this.x+w>=this.element.parentNode.clientWidth)this.x=this.element.parentNode.clientWidth-w;
		//move slider
